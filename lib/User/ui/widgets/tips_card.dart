...
class _TipsCard extends State<TipsCard> {
                     ...
                     GestureDetector(                           
                        onTap: () { 
                          Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                    builder: (BuildContext context) => TipListScreen("tips"),
                                    )
                                  );
                         },
                          child:Container(
                        ...
                        InkWell(                 //Para crear un botón personalizado
                          onTap: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (BuildContext context) => TipScreen(data.tipToday[0].uid, "tips"),
                                )
                              );
